...
/**
 * Retains and manages state information between runtime configuration changes to an Activity. Plays the role of the
...
public class RetainedFragmentManager {
	...
	/**
	 * "Headless" Fragment that retains state information between configuration changes. Plays the role of the "Memento"
