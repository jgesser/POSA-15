 ...
 *
 * @brief This class uses synchronous AIDL interactions to expand weathers via an Weather Web service. The
...
public class WeatherServiceSync extends LifecycleLoggingService {
	/**
	 * Factory method that makes an Intent used to start the WeatherServiceSync when passed to bindService().
	 *
	 * @param context
