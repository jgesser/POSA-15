...
/**
 * Super class that defines common keys and methods used by the RequestMessage and ReplyMessage subclasses.
 */
class RequestReplyMessageBase {
	...
	/**
	 * Accessor method that returns the Bundle that's part of the underlying Message.
	 */
	...
	/**
	 * Accessor method that returns the result code of the message, which can be used to check if the download
	 * succeeded.
	 */
